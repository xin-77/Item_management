...
public class UserController {
    ...
    public Result<?> login(@RequestBody User user){
        User res = userMapper.selectOne(new LambdaQueryWrapper<User>().eq(User::getUsername,user.getUsername()).eq(User::getPassword,user.getPassword()));
        if(res == null)
        {
    ...
    public Result<?> findPage(@RequestParam(defaultValue = "1") Integer pageNum,
        ...
        Page<User> userPage = (Page<User>) userMapper.selectPage(new Page<>(pageNum,pageSize), wrappers);
